// Path data copied verbatim from the downloaded "x-close" asset (via
// get_design_context on resultRow). Fixed to the Error state, not a
// swappable iconSlot -- inlined the same way as the other fixed icons
// in this project.
